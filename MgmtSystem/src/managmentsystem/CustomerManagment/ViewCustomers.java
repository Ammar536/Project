...
public class ViewCustomers extends javax.swing.JFrame {
    ...
    public ViewCustomers() {
        ...
        cList = cdao.viewAllCustomers();

        DefaultTableModel model = (DefaultTableModel) table.getModel();
        for(User c:cList)
        {
            Object[] row = {c.getId(), c.getFirstName(), c.getLastName(), c.getCnic(),c.getPhone(), c.getEmail(), c.getAddress() };
            model.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "First Name", "Last Name", "CNIC", "Phone", "Email", "Address"
            }
        ) {
