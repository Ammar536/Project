...
public class ViewEmployees extends javax.swing.JFrame {
    ...
    public ViewEmployees() {
        ...
        List<User> eList = new ArrayList<>();
        EmployeeController employeeController = new EmployeeController();
        eList = employeeController.viewEmployees();

        DefaultTableModel model = (DefaultTableModel) table.getModel();
        for(User e:eList)
        {
            Employee ex=(Employee) e;
            Object[] row = {ex.getId(), ex.getFirstName(), ex.getLastName(), ex.getCnic(),ex.getPhone(), ex.getEmail(), ex.getDesignation()};
            model.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "First Name", "Last Name", "CNIC", "Phone", "Email", "Designation"
            }
        ) {
